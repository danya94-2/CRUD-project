...
//MVC2모델 (모델을 지켜야 유지보수가 좋다)
//FrontController -> Controller -> Service -> DAO ->DB
//				<-				<-			 <- 	 <-
public class EmpController implements CommonControllerInterface{
	...
	private static void f_sp_call() {
		...
		EmpDTO emp = empService.excute_sp(employee_id);
	...
	private static void menuDisplay() {
		System.out.println("-------------------------");
		System.out.println("1.모두조회 2.조회(직원번호) 3.조회(부서) 4.조회(직책) 10.프로시저호출 99.끝    ");
